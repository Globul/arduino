 ...
 void loop()
{
  ...
  LED_P6x8Str(1,1,"I2C Scanner");
  LED_P6x8Str(1,2,"Scanning...");
  ...
  for(address = 1; address < 127; address++ )
  {
    ...
    if (error == 0)
    {
      LED_P6x8Str(1,3,"I2C device found at address 0x");
      if (address<16)
        LED_P6x8Str(1,4,"0");
      sprintf(tmp, "0x%x !", address);
      LED_P6x8Str(1,4,tmp);
...
//      LED_P6x8Str(3,4,"  !");
    ...
    {
      sprintf(tmp, "Error %d at 0x%x", error, address);
      LED_P6x8Str(1,4,tmp);
    }
  }
  if (nDevices == 0)
    LED_P6x8Str(1,5,"No I2C devices found");
  else
    LED_P6x8Str(1,5,"done\n");
