...
int IRPIN=6;  // Infrared receptor
int MOTOR=8;  // Car motor
...
void dispKey(int code)
{
  switch (code)
  {
    case 0xa25d:      LED_P8x16Str(1,5,"CH- "); break;
    case 0x629d:      LED_P8x16Str(1,5,"CH  "); break;
    case 0xe21d:      LED_P8x16Str(1,5,"CH+ "); break;
    case 0x22dd:      LED_P8x16Str(1,5,"PREV"); break;
    case 0x02fd:      LED_P8x16Str(1,5,"NEXT"); break;
    case 0xc23d:      LED_P8x16Str(1,5,"PLAY"); break;
    case 0xe01f:      LED_P8x16Str(1,5,"VOL-"); break;
    case 0xa857:      LED_P8x16Str(1,5,"VOL+"); break;
    case 0x906f:      LED_P8x16Str(1,5,"EQ  "); break;
    case 0x6897:      LED_P8x16Str(1,5,"0   "); break;
    case 0x9867:      LED_P8x16Str(1,5,"100+"); break;
    case 0xb04f:      LED_P8x16Str(1,5,"200+"); break;
    case 0x30cf:      LED_P8x16Str(1,5,"1   "); break;
    case 0x18e7:      LED_P8x16Str(1,5,"2   "); break;
    case 0x7a85:      LED_P8x16Str(1,5,"3   "); break;
    case 0x10ef:      LED_P8x16Str(1,5,"4   "); break;
    case 0x38c7:      LED_P8x16Str(1,5,"5   "); break;
    case 0x5aa5:      LED_P8x16Str(1,5,"6   "); break;
    case 0x42bd:      LED_P8x16Str(1,5,"7   "); break;
    case 0x4ab5:      LED_P8x16Str(1,5,"8   "); break;
    case 0x52ad:      LED_P8x16Str(1,5,"9   "); break;
 ...
 void loop()
{
  ...
  LED_P8x16Str(1,0,"IR remote codes");

  if (irrecv.decode(&results))
  {
    sprintf(buf, "code = 0x%04x", results.value);
    LED_P8x16Str(1,3,buf);
    dispKey(results.value);
    switch (results.value)
    {
    	case 0xe01f:      digitalWrite(MOTOR, LOW); break;
    	case 0xa857:      digitalWrite(MOTOR, HIGH); break;
    }
