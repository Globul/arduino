...
int SCL_PIN=16;//D0   NodeMCU D0
int SDA_PIN=5; //D1   NodeMCU D1
int RST_PIN=13;//RST  NodeMCU D7
int DC_PIN=12; //DC   NodeMCU D6
...
void setup()
{
  ...
  LED_P6x8Str(1,1,"[SETUP] wait 4 s ...");
  delay(4000);

  WiFi.mode(WIFI_STA);
  WiFiMulti.addAP("NETGEAR59", "seafight");
}
 ...
 void loop()
{
  ...
  LED_P6x8Str(1,1,"Connection ...");
    ...
    if((WiFiMulti.run() == WL_CONNECTED)) {
        ...
        LED_P6x8Str(1,3,"[HTTP] begin...");
        // configure traged server and url
        //http.begin("https://192.168.1.12/test.html", "7a 9c f4 db 40 d3 62 5a 6e 21 bc 5c cc 66 c8 3e a1 45 59 38"); //HTTPS
        http.begin("http://192.168.1.254/cgi-bin/testNM.sh"); //HTTP

        LED_P6x8Str(1,3,"[HTTP] GET...");
        ...
        if(httpCode > 0) {
            ...
            sprintf(tmp, "[HTTP] GET code: %d", httpCode);
            LED_P6x8Str(1,3,tmp);

            // file found at server
            if(httpCode == HTTP_CODE_OK) {
                strncpy(tmp, http.getString().c_str(), sizeof(tmp)-1);
                tmp[sizeof(tmp)-1] = '\0';
                pt = strchr(tmp, '\r');
                if (pt) *pt = '\0';
                pt = strchr(tmp, '\n');
            ...
            sprintf(tmp, "[HTTP] GET failed, error: %s", http.errorToString(httpCode).c_str());
            LED_P6x8Str(1,3,tmp);
        }
